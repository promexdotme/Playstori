...
if(local_data){ //Load existing game data
	...
	game_data = JSON.parse(JSON.stringify(default_game_data));
}
var first_play = 1;
	...
	create(){
		...
		function completed(){
			...
			function show_window(){
				...
				self.add.text(360, 460, 'Bonus coin: +'+arr.length, {fontFamily: 'robotomono', fontSize: 35, align: 'center', color: '#fff'}).setOrigin(0.5);
