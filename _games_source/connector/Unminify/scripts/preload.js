class Load extends Phaser.Scene {
	...
	preload(){
		...
		this.load.image('btn_newgame', 'img/btn_newgame.png');
		for(let i=1; i<=15; i++){
			this.load.image(String(i), 'img/'+i+'.png');
		}
		this.load.image('1x', 'img/1x.png');
		this.load.image('5x', 'img/5x.png');
		this.load.image('7x', 'img/7x.png');
		this.load.image('8x', 'img/8x.png');
		//Load all levels
