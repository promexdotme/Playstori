...
var storage_key = 'rf.jewel_miner';
//localStorage.removeItem(storage_key);
load_data();
function load_data(){
	let local_data = localStorage.getItem(storage_key);
...
class Menu extends Phaser.Scene {
	...
	create(){
		...
		this.add.text(400, 780, bestscore, {fontFamily: 'vanilla', fontSize: 38, align: 'center',color: '#FFFFFF'}).setOrigin(0.5);
