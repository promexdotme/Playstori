...
var storage_key = 'rf.memory_match';
...
class Menu extends Phaser.Scene {
	...
	create(){
		...
		this.add.sprite(340, 640, 'best_bar_large');
		this.add.text(510, 635, bestscore, {fontFamily: 'vanilla', fontSize: 50, align: 'right',color: '#844f29'}).setOrigin(1, 0.5);
		let b_play = draw_button(360, 800, 'start', this);
